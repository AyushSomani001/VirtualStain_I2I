...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='VirtualStain_Model', help='name of the experiment. It decides where to store samples and models')        
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        self.parser.add_argument('--model', type=str, default='VirtualStain_I2I', help='which model to use')
        ...
        # Setting inputs
        self.parser.add_argument('--dataroot', type=str, default='D:/Somani/Set3') 
        ...
        self.parser.add_argument('--n_blocks_global', type=int, default=7, help='number of residual blocks in the global generator network')
        self.parser.add_argument('--n_blocks_local', type=int, default=4, help='number of residual blocks in the local enhancer network')
        ...
        self.parser.add_argument('--n_clusters', type=int, default=5, help='number of clusters for features')        
